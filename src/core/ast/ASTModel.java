...
import core.ast.treeview.AbstractTreeTableModel;
import core.ast.treeview.TreeTableModel;

public class ASTModel extends AbstractTreeTableModel
        implements TreeTableModel
{
    ...
    public ASTModel(IASTNode root)
    {
        super(new ASTNode(root));
    }
